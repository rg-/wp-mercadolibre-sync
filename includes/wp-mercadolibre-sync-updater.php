...
// https://raw.githubusercontent.com/jkudish/WordPress-GitHub-Plugin-Updater/master/updater.php
...
if (is_admin()) { // note the use of is_admin() to double check that this is happening in the admin
    $config = array(
        'slug' => 'wp-mercadolibre-sync', // this is the slug of your plugin
        'proper_folder_name' => 'wp-mercadolibre-sync', // this is the name of the folder your plugin lives in
        'api_url' => 'https://api.github.com/repos/rg-/wp-mercadolibre-sync', // the github API url of your github repo
        'raw_url' => 'https://raw.github.com/rg-/wp-mercadolibre-sync/master', // the github raw url of your github repo
        'github_url' => 'https://github.com/rg-/wp-mercadolibre-sync', // the github url of your github repo
        'zip_url' => 'https://github.com/rg-/wp-mercadolibre-sync/zipball/master', // the zip url of the github repo
        'sslverify' => true, // wether WP should check the validity of the SSL cert when getting an update, see https://github.com/jkudish/WordPress-GitHub-Plugin-Updater/issues/2 and https://github.com/jkudish/WordPress-GitHub-Plugin-Updater/issues/4 for details
        'requires' => '4.8', // which version of WordPress does your plugin require?
        'tested' => '5.2.2', // which version of WordPress is your plugin tested up to?
