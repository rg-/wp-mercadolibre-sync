      ...
      <div class="wpmlsync__postbox-inner">
        ...
        <div class="wpmlsync__row">
          ...
          <div class="wpmlsync__col w-33">
            <div class="wpmlsync__card">
                <h3 class="wpmlsync__postbox-subtitle">Estado del sistema <?php if($global_meli_code==6){
                  echo '<span class="wpmlsync__badge success">Actived</span>';
                }?></h3>
                <?php echo '<p>'.$meli_code_array[$global_meli_code]['desc'].'</p>';?>
                #<?php echo $global_meli_code; ?>
            </div>
          </div>

          <div class="wpmlsync__col w-33">
            <div class="wpmlsync__card">
                <h3 class="wpmlsync__postbox-subtitle">App Vinculada</h3>
                <?php 
                  if( $global_meli_code==6 || $global_meli_code==4 ){
                    ?>
                    <p><span class="dashicons dashicons-yes"></span> Applicacion vinculada.</p>
                    <?php
                  }else{ 
                    ?>
              ...
              <div class="wpmlsync__card">
                ...
                <?php 
                  ...
                  if($global_meli_code==6){
                    ...
                    echo "<p>Expires in time: <small>".date('Y-m-d H:i:s', $expires_in)."</small></p>";
                    echo "<p>Current time: <small>".date('Y-m-d H:i:s', time())."</small></p>";
                  }
                  if(!empty($expires_in) < time()) {  
        ...
        <div class="wpmlsync__row">
          ...
          <?php 
            if($global_meli_code==0 || $global_meli_code==6){
            ...
            if($global_meli_code==6){ 
              echo '<a class="button button-primary wpmlsync__button" href="' . $global_meli->getAuthUrl($redirectURI, Meli::$AUTH_URL[$siteId]) . '">Autorize your APP again</a>';
            }
            if($global_meli_code==7 || $global_meli_code==4){
              echo '<a class="button button-primary wpmlsync__button" href="' . $global_meli->getAuthUrl($redirectURI, Meli::$AUTH_URL[$siteId]) . '">Autorize your APP</a>'; 
              echo '<a class="button button-secondary wpmlsync__button" href="https://applications.mercadolibre.com/" target="_blank">Manage your Mercado Libre applications</a>';
            }
          ?>
          </div>
    ...
    <div class="wpmlsync__postbox-container">
      <div class="wpmlsync__postbox-inner">
        <form action='options.php' method='post'> 
          ...
          ?>
          <h2 class="wpmlsync__postbox-title">API Settings</h2>
          <?php
          do_settings_sections( 'wp-mercadolibre-sync' );
          ?>
          <h2 class="wpmlsync__postbox-title">oAuth Token</h2>
          <?php
